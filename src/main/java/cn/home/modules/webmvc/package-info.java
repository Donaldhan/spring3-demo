 ...
 *                 AnnotationMethodHandlerAdapter HandlerInterceptor
 *                 SimpleUrlHandlerMapping BeanNameUrlHandlerMapping
 * 
 *                 WebDataBinder ServletRequest HttpServletRequest HttpSession
 *                 WebRequest NativeWebRequest Principal HttpMessageConverters
 * 
 *                 HttpMessageConverter is responsible for converting from the
 *                 HTTP request message to an object and converting from an
 *                 object to the HTTP response body. The
 *                 RequestMappingHandlerAdapter supports the @RequestBody
 ...
 *                 MultiValueMap<String, String>. SourceHttpMessageConverter
 *                 converts to/from a javax.xml.transform.Source.
 * 
 *                 DefaultHandlerExceptionResolver
 * @SessionAttributes WebBindingInitializer
 *
 *                    ResourceBundle UrlBasedViewResolver
 *                    InternalResourceViewResolver HandlerExceptionResolver
 *                    SimpleMappingExceptionResolver
 * @ExceptionHandler ExceptionHandlerExceptionResolver
 * @ControllerAdvice
 *
 *
 * 					<mvc:annotation-driven /> The above registers a
 *                   RequestMappingHandlerMapping, a
 *                   RequestMappingHandlerAdapter, and an
 *                   ExceptionHandlerExceptionResolver (among others) in support
 *                   of processing requests with annotated controller methods
 *                   using annotations such as @RequestMapping
